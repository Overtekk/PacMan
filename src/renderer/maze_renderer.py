...
#  Updated: 2026/05/15 17:29:40 by anacharp        ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
class Wall(arcade.Sprite):
    def __init__(self, sprite_path: str, angle: float = 0,
                 center_x: float = 0, center_y: float = 0, tile_size: int = 0) -> None:
        super().__init__(sprite_path, center_x=center_x,
                         center_y=center_y)
        self.angle = angle
...
class GameRenderer():
    ...
    def wall_generator(
        self,
        wall_data: list[tuple[str, float, float, float]]) -> None:
