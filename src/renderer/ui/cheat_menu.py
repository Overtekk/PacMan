...
#  Updated: 2026/06/01 14:44:03 by roandrie        ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
class ExtraTime(BaseButton):
    ...
    def _activate_cheat(self) -> None:
        if game_config.debug_mode:
            print_log("Cheat mode: +10 seconds")

        self.parent_view.previous_view.state_manager.time_left += 10
...
class SpeedUpButton(BaseButton):
    ...
    def _activate_cheat(self) -> None:
        if game_config.debug_mode:
            print_log("Cheat mode: +50 speed")

        self.parent_view.previous_view.player.speed += 50
